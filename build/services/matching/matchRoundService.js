...
export class MatchRoundService {
    constructor() {
        Object.defineProperty(this, "matchingService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async createMatchRound(activityId, name, scheduledTime) {
    ...
    async getMatchRounds(activityId) {
        const { data, error } = await supabase
            .from('match_round')
            .select('*')
